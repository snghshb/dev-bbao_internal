...
<tr>
<td width="50%" class="tableBox">
<h3>ROSTERS</h3>
<form class="form-horizontal" action="searchRosters.php" name="searchRosters" method="post" enctype="multipart/form-data">
<div class="form-group">
	<label class="control-label col-sm-2" for="semesterTerm">TERM</label>
	<div class="col-sm-10">
...
<div class="form-group">
	<label class="control-label col-sm-2" for="semesterYear">YEAR</label>
	<div class="col-sm-10">
...
<td class="tableBox">
<h3>STUDENT LIST</h3>
<form class="form-horizontal" action="searchCohorts.php" name="searchCohorts" method="post" enctype="multipart/form-data">
<div class="form-group">
...
<form class="form-horizontal" action="downloadStudentReport.php" name="downloadStudentReport" method="post" enctype="multipart/form-data">
<div class="form-group">
...
<div class="form-group">        
		<div class="col-sm-offset-2 col-sm-10">
			<button type="submit" class="btn btn-default">DOWNLOAD STUDENT REPORT</button>
		</div>
    </div>
	</form>
</td>
